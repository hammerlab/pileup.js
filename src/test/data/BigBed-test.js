...
describe('BigBed', function() {
  function getTestBigBed() {
    return BigBed.load('/test-data/itemRgb.bb');   // See test-data/README.md
  }
          ...
          expect(features).to.deep.equal([
            {
              ...
              start: 151077031,
              stop: 151078198,
              rest: "MID_BLUE	0	-	151077031	151078198	0,0,128"
            },
            {
              contig: 'chrX',
              start: 151078198,
              stop: 151079365,
              rest: "VIOLET_RED1	0	-	151078198	151079365	255,62,150"
            }
          ]);
        });
  });
