...
// Note: Flow doesn't support callable modules.
/**
...
declare module "q" {
     ...
     */
    // declare function try(method: Function, ...args: any[]): Promise<any>;

    declare function fbind<T>(method: (...args: any[]) => T | IPromise<T>, ...args: any[]): (...args: any[]) => Promise<T>;

    declare function fcall<T>(method: (...args: any[]) => T, ...args: any[]): Promise<T>;

    declare function send<T>(obj: any, functionName: string, ...args: any[]): Promise<T>;
    declare function invoke<T>(obj: any, functionName: string, ...args: any[]): Promise<T>;
    declare function mcall<T>(obj: any, functionName: string, ...args: any[]): Promise<T>;

    declare function denodeify<T>(nodeFunction: Function, ...args: any[]): (...args: any[]) => Promise<T>;
    declare function nbind<T>(nodeFunction: Function, thisArg: any, ...args: any[]): (...args: any[]) => Promise<T>;
    declare function nfbind<T>(nodeFunction: Function, ...args: any[]): (...args: any[]) => Promise<T>;
    declare function nfcall<T>(nodeFunction: Function, ...args: any[]): Promise<T>;
    declare function nfapply<T>(nodeFunction: Function, args: any[]): Promise<T>;

    declare function ninvoke<T>(nodeModule: any, functionName: string, ...args: any[]): Promise<T>;
    declare function npost<T>(nodeModule: any, functionName: string, args: any[]): Promise<T>;
    declare function nsend<T>(nodeModule: any, functionName: string, ...args: any[]): Promise<T>;
    declare function nmcall<T>(nodeModule: any, functionName: string, ...args: any[]): Promise<T>;

    /**
     * Returns a promise that is fulfilled with an array containing the fulfillment value of each promise, or is rejected with the same rejection reason as the first promise to be rejected.
     */
    declare function all<T>(promises: Promise<T>[]): Promise<T>; // catch all
     ...
     */
    declare function allSettled<T>(promises: IPromise<T>[]): Promise<PromiseState<T>[]>;

    declare function allResolved<T>(promises: IPromise<T>[]): Promise<Promise<T>[]>;
    ...
    // [14:01] <@glevi> danvk: Yeah, looks like something I missed when converting the d.ts file. Flow doesn't understand overloading yet
    /**
     * Returns a promise that will have the same result as promise, but will only be fulfilled or rejected after at least ms milliseconds have passed.
     */
    // declare function delay<T>(promise: Promise<T>, ms: number): Promise<T>;
    /**
     * Returns a promise that will have the same result as promise, but will only be fulfilled or rejected after at least ms milliseconds have passed.
     */
    // declare function delay<T>(value: T, ms: number): Promise<T>;
    /**
     ...
     * Returns whether a given promise is in the fulfilled state. When the static version is used on non-promises, the result is always true.
     */
    declare function isFulfilled(promise: Promise<any>): boolean;
    /**
     * Returns whether a given promise is in the rejected state. When the static version is used on non-promises, the result is always false.
     */
    declare function isRejected(promise: Promise<any>): boolean;
    /**
     * Returns whether a given promise is in the pending state. When the static version is used on non-promises, the result is always false.
     */
    declare function isPending(promise: Promise<any>): boolean;
    ...
    // Incompatible with Flow. See https://github.com/facebook/flow/issues/589
    // declare function Promise<T>(resolver: (resolve: (val: T | IPromise<T>) => void , reject: (reason: any) => void , notify: (progress: any) => void ) => void ): Promise<T>;
     ...
     */
    declare function promised<T>(callback: (...args: any[]) => T): (...args: any[]) => Promise<T>;

    /**
     * Returns whether the given value is a Q promise.
     */
    declare function isPromise(object: any): boolean;
    /**
     * Returns whether the given value is a promise (i.e. it's an object with a then function).
     */
    declare function isPromiseAlike(object: any): boolean;
    /**
     * Returns whether a given promise is in the pending state. When the static version is used on non-promises, the result is always false.
     */
    declare function isPending(object: any): boolean;
     ...
     */
    declare function async<T>(generatorFunction: any): (...args: any[]) => Promise<T>;
     ...
     */
    declare var onerror: (reason: any) => void;
    /**
     ...
     */
    declare var longStackSupport: boolean;
     ...
     */
    declare function resolve<T>(object: IPromise<T>): Promise<T>;
    /**
     * Calling resolve with a pending promise causes promise to wait on the passed promise, becoming fulfilled with its fulfillment value or rejected with its rejection reason (or staying pending forever, if the passed promise does).
     * Calling resolve with a rejected promise causes promise to be rejected with the passed promise's rejection reason.
     * Calling resolve with a fulfilled promise causes promise to be fulfilled with the passed promise's fulfillment value.
